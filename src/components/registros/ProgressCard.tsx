        ...
        <div className="group relative h-full">
            ...
            <div className="relative bg-[#333333] rounded-xl p-6 shadow-lg border border-gray-700 h-full flex flex-col justify-between">
                <div className="flex justify-between items-start mb-4">
                    ...
                    <button onClick={onShowDetails} disabled={!isEnabled} className={`p-2.5 rounded-lg transition-all duration-200 border ${isEnabled ? "bg-[#222222] text-primary border-transparent hover:bg-[#444444] cursor-pointer shadow-[0_4px_10px_rgba(0,0,0,0.2)]" : "bg-[#333333] text-[#666666] border-[#444444] cursor-not-allowed"}`}>
                ...
                <div className="w-full bg-gray-700 rounded h-6 overflow-hidden">
                    <div className={`${config.bgColor} h-full transition-all duration-300 rounded`} style={{ width: `${percentage}%` }} />
                </div>
            </div>
        </div>
    );
