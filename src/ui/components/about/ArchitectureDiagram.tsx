        ...
        <div className="flex flex-col items-center space-y-6">
            ...
            <div className="w-full max-w-5xl">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-gradient-to-br from-cyan-900/30 to-cyan-700/30 border-2 border-cyan-500 rounded-lg p-6 hover:scale-105 transition-transform">
                        ...
                        <a
                            ...
                            className="block text-center text-xs text-cyan-400 hover:text-cyan-300 underline"
                        >
                            Ver repositorio →
                        </a>
                    </div>

                    <div className="bg-gradient-to-br from-green-900/30 to-green-700/30 border-2 border-green-500 rounded-lg p-6 hover:scale-105 transition-transform">
                        <div className="text-4xl mb-3 text-center">📱</div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-900/30 to-indigo-700/30 border-2 border-indigo-500 rounded-lg p-6 hover:scale-105 transition-transform">
                        <div className="text-4xl mb-3 text-center">💻</div>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block text-center text-xs text-indigo-400 hover:text-indigo-300 underline"
                        >
                            Ver repositorio →
                        </a>
                    </div>
            ...
            <div className="w-full max-w-4xl">
                <div className="bg-gradient-to-r from-purple-900/30 to-purple-700/30 border-2 border-purple-500 rounded-lg p-6 hover:scale-105 transition-transform">
